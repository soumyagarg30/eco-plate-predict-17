    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="flex gap-6">
          <Tabs defaultValue="profile" className="flex flex-row gap-6 w-full" orientation="vertical">
            <Card className="border shadow h-fit">
              <CardContent className="p-0">
                <TabsList orientation="vertical" className="w-full bg-transparent rounded-md">
                  ...
                  <TabsTrigger value="food-requests" orientation="vertical" className="flex items-center gap-2 px-4 py-3">
                    <ClipboardList className="h-5 w-5" />
                    <span className="text-base">Food Requests</span>
                  </TabsTrigger>
            ...
            <div className="flex-1">
              ...
              <TabsContent value="food-requests" className="m-0">
